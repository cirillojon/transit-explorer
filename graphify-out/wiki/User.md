...
> God node · 31 connections · `/mnt/c/Users/Jonat/projects/tm-project-folder/transit-explorer/app/models.py`
...
- [[Seed a single 2-hop trip (stops[0] -> stops[2]) where the rows are     inserted]] `INFERRED`
- [[Even when rows were inserted in shuffled order, /me/progress     should return]] `INFERRED`
